                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-positive mt-3 text-xs font-semibold">
                        {line.winner
                          ? `${line.winner} ${game.postseasonRole === "CHAMPIONSHIP" ? "won the championship" : game.scope === "PLAYOFF" && game.week < 17 ? "advanced" : "won"}${game.advancementReason ? ` · ${game.advancementReason.toLowerCase().replaceAll("_", " ")}` : ""}`
